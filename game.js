...
var ACTIVE_GOAL_COLOR = draw.colors.MINERGREEN;

var gridActive = {};

var scaling = 3;
var squareSize = 15;
var gameSquareSize = 8;
...
var sizeOfGoal = new Vector2(3,2);
...
{
  constFlag = false;
  gameSquareSize = document.getElementById('gridSizeRange').value;
  scaling = document.getElementById('scalingRange').value;
  numPixels = document.getElementById('numPixelsRange').value;
}
